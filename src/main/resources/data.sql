...
(id, closed_date_time, created_date_time, description, latitude, longitude, location,
 ...
 price_negotiation, location_guide, cancel)
VALUES (1, '2023-08-03-16-00', '2022-08-03-16-00', '떡볶이 쉐어 설명', 37.499237, 127.026364, '강남역',
       ...
       (2, '2023-07-03-16-00', '2022-07-03-16-00', '치킨 쉐어 설명', 37.3951627, 127.1117136, '판교역',
        28000, 7000, 4, '판교역에서 치킨 먹을 사람 모집합니다.', 'DELIVERY', 2355841047, false, true, '판교역 2번 출구', false),
...
VALUES (1, '떡볶이', '목동', 37.524159, 126.872879, 2370842997),
       ...
       (6, '햄버거', '방이동', 37.5132612, 127.1001336, 2370842997),
       (7, '피자', '방이동', 37.5132612, 127.1001336, 2370842997),
       (8, '쌀국수', '방이동', 37.5132612, 127.1001336, 2370842997),
       (9, '테스트', '방이동', 37.5132612, 127.1001336, 2355841047),
       (10, '테스트', '강남역', 37.499237, 127.026364, 2355841047);
