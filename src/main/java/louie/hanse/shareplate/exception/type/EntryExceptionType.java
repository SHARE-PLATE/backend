...
public enum EntryExceptionType implements ExceptionType {
    ...
    SHARE_ALREADY_CANCELED("ENTRY002", "참가되어 있지 않은 쉐어입니다.", BAD_REQUEST),
    SHARE_OVERCAPACITY("ENTRY003", "모집정원이 초과된 쉐어입니다.", BAD_REQUEST),
    CLOSE_TO_THE_APPOINTMENT_TIME("ENTRY004", "모집시간 1시간 미만으로 남은 경우, 참가 취소를 할 수 없습니다.", BAD_REQUEST),
    APPOINTMENT_TIME_HAS_PASSED("ENTRY005", "모집이 지난 쉐어의 경우, 참가 취소를 할 수 없습니다.", BAD_REQUEST);
